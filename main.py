...
Please make sure to replace the `config.txt` file and the `theClass` list with your own data. Also, remember to install the necessary dependencies by running `pip install requests zhdate` in your terminal before running the modified code.
